...
import { Canvas, useFrame } from "react-three-fiber"; //! NO LONGER useRender... NOW useFrame !//
// A React animation lib, see: https://github.com/react-spring/react-spring

import { useSpring, animated } from "react-spring/three";
import classes from "./SpaceExample.module.scss";
...
const Stars = () => {
  ...
  const [geo, mat, coords] = useMemo(() => {
    ...
    const coords = new Array(2000) //* Makes an array of coords randomly placed in 3d space
      .fill()
      .map((i) => [
        Math.random() * 800 - 400,
        Math.random() * 800 - 400,
